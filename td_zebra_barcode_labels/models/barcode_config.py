...
class TDZebraBarcodeConfiguration(models.Model):
    ...
    fourth_padding_top = fields.Integer(string="Padding(Top)", default=1)
    fourth_padding_bottom = fields.Integer(string="Padding(Bottom)", default=1)
    fourth_padding_left = fields.Integer(string="Padding(Left)", default=1)
    fourth_padding_right = fields.Integer(string="Padding(Right)", default=1)
